...
function create_card( id ) {
    ...
    newTitle.innerHTML = info[id-1].Name;
    // number 
    let newNumber =document.createElement("h1");
    newNumber.classList.add("subject-number");
    newNumber.innerHTML = "#" + id;
    // image
    ...
    title_container.appendChild(newNumber);
